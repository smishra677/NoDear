...
for ii in sim:
    ...
    for simNum in range(sim[ii]):
        ...
        print(simNum)
        os.system('pyrho make_table -n 20 -N 25 --numthreads 100 --mu 1e-8 --logfile . --outfile '+str(simNum)+'_lookuptable.hdf --approx --smcpp_file '+sim_file+'.csv --decimate_rel_tol 0.1')
